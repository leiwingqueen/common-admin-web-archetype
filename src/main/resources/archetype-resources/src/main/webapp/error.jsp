...
<div class="wrap-head">
	<div class="header">
		<div class="logo">
            ...
            <span class="text">出错啦 ~${symbol_escape}(≧▽≦)/~</span>
        </div>
        <div class="cont">
