...
<jsp:include page="/include/hd.jsp"></jsp:include>
                ...
                <div class="row-fluid">
                	<div class="portlet box blue">
                	    ...
                	    <div class="portlet-body">
                	    	<form action="${symbol_pound}" id="J_formDemo" class="form form-horizontal">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" placeholder="确认密钥" required equalTo="${symbol_pound}J_key" class="m-wrap span12" />
                                    </div>
                                </div>
                                <div class="control-group">
    ...
    <script>
        ${symbol_dollar}(document).ready(function() {    
            ...
            App.validate('${symbol_pound}J_formDemo',function(){
                foo('提交数据2');
            })
        });
    </script>
