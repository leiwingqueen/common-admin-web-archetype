					...
					<section>
						...
						<article class="help-page">
							<div id="J_helpHead" class="hd default bs-docs-example">
								<a href="${symbol_pound}" class="J_helpSlider" id="J_helpSlider">鼠标移到上面，显示目录！</a>
											...
											<dd>
												<ul style="display: block; position: static;" role="menu" class="dropdown-menu">
													<li class="dropdown-submenu help-submemu">
														<a href="${symbol_pound}a-1" tabindex="-1">工具管理</a>
														<ul class="dropdown-menu">
															<li><a href="${symbol_pound}a-1-1">可执行工具</a></li>
															<li><a href="${symbol_pound}a-1-2">待审核工具</a></li>
															<li><a href="${symbol_pound}a-1-3">工具列表</a></li>
														</ul>
													</li>
													<li class="dropdown-submenu help-submemu">
														<a href="${symbol_pound}a-2" tabindex="-1">系统日志</a>
														<ul class="dropdown-menu">
															<li><a href="${symbol_pound}a-2-1">操作日志</a></li>
															<li><a href="${symbol_pound}a-2-2">执行任务查询</a></li>
															<li><a href="${symbol_pound}a-2-3">服务器执行日志查询</a></li>
															<li><a href="${symbol_pound}a-2-4">任务文件下载</a></li>
														</ul>
													</li>
													<li class="dropdown-submenu help-submemu">
														<a href="${symbol_pound}a-3" tabindex="-1">参数配置</a>
														<ul class="dropdown-menu">
															<li><a href="${symbol_pound}a-3-1">字典参数设置</a></li>
															<li><a href="${symbol_pound}a-3-2">工具分类</a></li>
															<li><a href="${symbol_pound}a-3-3">终止任务管理</a></li>
														</ul>
													</li>
									...
									<li>
										<dl class="clearfix">
											...
											<dd>
												<ul style="display: block; position: static;" role="menu" class="dropdown-menu">
													<li class="dropdown-submenu help-submemu">
														<a href="${symbol_pound}b-1" tabindex="-1">工具新建</a>
														<ul class="dropdown-menu">
															<li><a href="${symbol_pound}b-1-1">工具名称</a></li>
															<li><a href="${symbol_pound}b-1-2">主脚本</a></li>
															<li><a href="${symbol_pound}b-1-3">主脚本类型</a></li>
															<li><a href="${symbol_pound}b-1-4">脚本执行类型</a></li>
															<li><a href="${symbol_pound}b-1-5">工具分类</a></li>
															<li><a href="${symbol_pound}b-1-6">工具说明</a></li>
															<li><a href="${symbol_pound}b-1-7">文件上传</a></li>
															<li><a href="${symbol_pound}b-1-8">拖拽控件</a></li>
															<li><a href="${symbol_pound}b-1-9">编辑结果表</a></li>
														</ul>
													</li>
													<li class="help-submemu">
														<a href="${symbol_pound}b-2" tabindex="-1">工具调试</a>
													</li>
													<li class="help-submemu">
														<a href="${symbol_pound}b-3" tabindex="-1">工具提交</a>
													</li>
													<li class="help-submemu">
														<a href="${symbol_pound}b-4" tabindex="-1">工具审核</a>
													</li>
													<li class="help-submemu">
														<a href="${symbol_pound}b-5" tabindex="-1">工具使用</a>
													</li>
													<li class="help-submemu">
														<a href="${symbol_pound}b-6" tabindex="-1">工具删除</a>
													</li>
												</ul>
											</dd>
										</dl>
									...
									<li>
										<dl class="clearfix">
											...
											<dd>
												<ul style="display: block; position: static;" role="menu" class="dropdown-menu">
													<li>
														<a href="${symbol_pound}c-1" tabindex="-1">SCANDISKINFO</a>
													</li>
												</ul>
											</dd>
										</dl>
									...
									<li>
										<dl class="clearfix">
											...
											<dd>
												<ul style="display: block; position: static;" role="menu" class="dropdown-menu">
													<li class="help-submemu">
														<a href="${symbol_pound}d-1" tabindex="-1">相关脚本</a>
													</li>
													<li class="help-submemu">
														<a href="${symbol_pound}d-2" tabindex="-1">工具平台设计文档</a>
													</li>
												</ul>
											</dd>
										</dl>
							...
							<div class="bd bs-docs-example">
								...
								<div class="alert alert-block alert-info">
									...
									<p>如：我上传<code>commonFunction.sh</code>，<code>scanProcess.sh</code>两个脚本（<a href="${symbol_pound}d-1">参照：附件</a>），其中<code>scanProcess.sh</code>是完成实际功能的脚本，</p>
								...
								<p>下面是我写的一个参数处理的公共函数，仅供参考（<a href="${symbol_pound}d-1">参照：附件</a>）：</p>
								<div class="bs-docs-example">
									<pre>
${symbol_pound}------------------------${symbol_pound}
${symbol_pound} 脚本参数相关信息       ${symbol_pound}
${symbol_pound}------------------------${symbol_pound}

${symbol_pound} 脚本参数解析（全局）
function parseParameter {

    ${symbol_pound} 将${symbol_escape}n替换成${symbol_escape}${symbol_escape}n，避免echo "${symbol_dollar}PARA_STRING"时直接就将${symbol_escape}干掉了，变成n
    
    sed -i 's${symbol_pound}${symbol_escape}${symbol_escape}n${symbol_pound}${symbol_escape}${symbol_escape}${symbol_escape}${symbol_escape}n${symbol_pound}g' para.config
    
    while read PARA_STRING ; do

        ${symbol_pound} 判断参数是否符合key=value格式
        
        if ! echo "${symbol_dollar}PARA_STRING" | egrep -q '^[^ =]+=[^ =]+.*${symbol_dollar}' ; then

            code=52 ; msg="${symbol_dollar}FUNCNAME [ERR ] | invalid format ${symbol_escape}"${symbol_dollar}PARA_STRING${symbol_escape}", it should be in key=value format"

            printResult "${symbol_dollar}code" "${symbol_dollar}msg"

            return ${symbol_dollar}code
             
        else
        
            ${symbol_pound} 遍历定义每一个参数
            
            ${symbol_pound} 参数名获取           
            PARA_NAME=${symbol_dollar}( echo "${symbol_dollar}PARA_STRING" | sed -r 's${symbol_pound}(.*)=(.*)${symbol_pound}${symbol_escape}1${symbol_pound}g' )
            
            ${symbol_pound} 参数值获取           
            PARA_VALUE=${symbol_dollar}( echo "${symbol_dollar}PARA_STRING" | sed -r 's${symbol_pound}(.*)=(.*)${symbol_pound}${symbol_escape}2${symbol_pound}g' )
            
            ${symbol_pound} 参数名，参数值对应赋值
            eval "${symbol_dollar}PARA_NAME=${symbol_escape}"${symbol_dollar}PARA_VALUE${symbol_escape}"" 2>/dev/null || { code=53 ; msg="${symbol_dollar}FUNCNAME [ERR ] | eval error"
            ...
            return ${symbol_dollar}code; }
								...
								<p>如：
									<code>scanProcess.sh</code>脚本（<a href="${symbol_pound}d-1">参照：附件</a>）的功能是获取用户输入的进程名称，并在相应SERVER上搜索是否存在此进程。
									<br>
									若存在，输出此进程相关信息；
									<br>
...
${symbol_pound} PARA_PROCESS_NAME

if [ -z "${symbol_dollar}PARA_PROCESS_NAME" ];then

    code=102; msg="${symbol_dollar}SCRIPT_NAME [ERR ] | PARA_PROCESS_NAME value is null."

    printResult "${symbol_dollar}code" "${symbol_dollar}msg" 

    exit ${symbol_dollar}code
...
用户告警信息过滤的工具<code>grepAlertInfo</code>（<a href="${symbol_pound}d-1">参照：附件</a>）的文本域：</p>
								<div class="helpImg">
								...
								<p>如：获取服务器信息的工具<code>serverInfo</code>（<a href="${symbol_pound}d-1">参照：附件</a>）里面的定义：</p>
								<div class="helpImg">
								...
								<p>如：执行磁盘readonly检测以及磁盘空间信息的工具<code>scanDiskInfo</code>（<a href="${symbol_pound}d-1">参照：附件</a>），其结果表定义如下：</p>
								...
								<div class="bs-docs-example">
<pre>${symbol_pound} 循环取出分区相关数据
	for PARTITION in ${symbol_dollar}(cat /etc/mtab |grep ^/dev |awk '{print ${symbol_dollar}2}');do
	
	
	    ${symbol_pound} 获取磁盘空间信息
	    DISK_SPACE=${symbol_dollar}(df -lh|grep -w "${symbol_dollar}PARTITION"${symbol_dollar}|tr -d ${symbol_escape}%|awk '{print ${symbol_dollar}NF,${symbol_dollar}(NF-1)}'|awk '{if(${symbol_dollar}2>'"${symbol_dollar}{PARA_THRESHOLD}"') print}')
	    
	    if [ "${symbol_dollar}DISK_SPACE" != "" ];then
	    
	        DISK_SPACE_STRING=${symbol_dollar}(echo "${symbol_dollar}DISK_SPACE"|sed -r 's/ +/${symbol_escape}t/g')
	        echo "DISK_SPACE${symbol_escape}t${symbol_dollar}IP_ADDR${symbol_escape}t${symbol_dollar}DISK_SPACE_STRING%"
	        
	    fi
	
	    
	    ${symbol_pound} 判断磁盘是否readonly状态
	    TEMP_FILE=${symbol_dollar}(mktemp -p ${symbol_dollar}PARTITION) && { rm -f ${symbol_dollar}TEMP_FILE ; echo "DISK_STATUS${symbol_escape}t${symbol_dollar}IP_ADDR${symbol_escape}t${symbol_dollar}PARTITION${symbol_escape}tok" ; } || echo "DISK_STATUS${symbol_escape}t${symbol_dollar}IP_ADDR${symbol_escape}t${symbol_dollar}PARTITION${symbol_escape}treadonly"
								...
								<h3 id="b-4">4.	工具审核</h3>
								<p class="alert alert-info">管理员对相关的工具进行审核操作。（<a href="${symbol_pound}">参照：待审核工具</a>）</p>
								<h3 id="b-5">5.	工具使用</h3>
	...
	<script type="text/javascript">
		${symbol_dollar}(function(){
			var J_helpSlider = ${symbol_dollar}('${symbol_pound}J_helpSlider'), J_helpNav = ${symbol_dollar}('${symbol_pound}J_helpNav'), J_helpHead = ${symbol_dollar}('${symbol_pound}J_helpHead'),
				pos = J_helpHead.offset().top,
				links = ${symbol_dollar}('${symbol_pound}J_helpNav').find('a');
			...
			// 跳转
			links.each(function(){
				${symbol_dollar}(this).on('click',function(){
					var obj = ${symbol_dollar}(this).attr('href').substring(1);
					J_helpSlider.click();
					${symbol_dollar}(window).scrollTop(${symbol_dollar}('${symbol_pound}'+obj).offset().top - 107);
					return false;
				})
			})
			${symbol_dollar}(window).scroll(function(){
				if(${symbol_dollar}(this).scrollTop() >= pos && J_helpHead.hasClass('default')){
					J_helpHead.removeClass('default').addClass('fixed');
					J_helpNav.slideUp();
				} else if(${symbol_dollar}(this).scrollTop() < pos && J_helpHead.hasClass('fixed')){
					J_helpHead.removeClass('fixed').addClass('default');
				}
				if(${symbol_dollar}(this).scrollTop() == 0){
					if(!J_helpNav.is(':visible')){
						J_helpNav.stop(true).slideDown();
					}
				}
