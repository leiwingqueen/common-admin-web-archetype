...
<head>
	...
	<link href="http://static.gzdai.com/sysop_fed_lib/assets/plugins/font-awesome/css/font-awesome.min.css"	rel="stylesheet" />
	...
	<div class="header navbar navbar-inverse navbar-fixed-top">
		...
		<div class="navbar-inner">
			<div class="container-fluid">
				<!-- BEGIN LOGO -->
				<a class="brand" href="/"> <img width="30" height="30" src="http://static.gzdai.com/sysop_fed_lib/assets/img/ico.png" alt="logo" /> <span class="font-small">统计系统</span> </a>
				<!-- END LOGO -->
				<!-- BEGIN 响应式时 菜单按钮 -->
				...
				<ul class="nav pull-right">
					<!-- BEGIN 用户信息 -->
					<li class="dropdown user"><a href="${symbol_pound}" class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="${symbol_pound}" id="J_logout"><i class="icon-key"></i>
									退出</a></li>
						</ul>
					</li>
					<!-- END 用户信息 -->
					<!-- BEGIN 快速通道 -->
					<li class="dropdown quick-launcher"><a href="${symbol_pound}" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true"> <span>快速通道</span>
